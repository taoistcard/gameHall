...
function ActivityManager:saveCommonJs() print("----saveCommonJs----")
	...
	local str = "var uid="..AccountInfo.userId.."; var os='"..ostype.."'; var model='iPhone'; var source='"..APP_CHANNEL.."'; var ver='"..getAppVersion().."'; var kid=6; var uuid='"..GetDeviceID().."'; var sessionid='"..AccountInfo.sessionId.."';"
...
function ActivityManager:callActivityWebView() 
	...
	if is_file_exists(filePath.."index.html") then
		...
		-- FreeChip(url)
		openPortraitWebView(url.."?sessionid="..AccountInfo.sessionId)
