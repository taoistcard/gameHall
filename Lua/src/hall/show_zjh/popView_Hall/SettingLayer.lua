...
function SettingLayer:createUI()
        ...
        function(sender,eventType)
            if eventType == ccui.TouchEventType.ended then
            	...
            	if SoundManager.bOpenMusic == 1 then
                    ...
                    SoundManager.play3CardHallBackGround()--SoundManager.playMusic("sound/hallbgm.mp3", true)
            	end
            end
        end
    )

    checkBoxButton1:setPosition(215, 210)
    ...
    local musicEffect = display.newTTFLabel({text = "音效",
                ...
                --:align(display.CENTER_TOP, 337, 389)
                :addTo(bgSprite)
    musicEffect:setPosition(94, 278)
    ...
    fankui:setTitleFontName(FONT_ART_TEXT);
    ...
    help:setTitleFontName(FONT_ART_TEXT);
...
function SettingLayer:helpHandler()
    local help = require("show_zjh.popView_Hall.HelpLayer").new()
    self:addChild(help)
end
