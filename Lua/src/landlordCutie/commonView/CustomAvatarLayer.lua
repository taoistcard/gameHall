...
function CustomAvatarLayer:createUI()
	...
	--photo
    local shadow = ccui.ImageView:create("customAvatar/shadow.png")
    shadow:setPosition(149, 91)
    bgSprite:addChild(shadow)
    local photobutton = ccui.Button:create("customAvatar/photoNormal.png","customAvatar/photoSelected.png");
    ...
    bgSprite:addChild(shadow)
    local camerabutton = ccui.Button:create("customAvatar/cameraNormal.png","customAvatar/camerSelected.png");
