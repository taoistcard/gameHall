...
function PhoneLoginLayer:showLogin(accountLogin)
    ...
    titleSprite:setPosition(cc.p(400, 500));
    ...
    local phoneLogin = ccui.Button:create("common/button_green.png");
    ...
    phoneLogin:getTitleRenderer():enableOutline(COLOR_BTN_GREEN,2);
    ...
    local forgetPage = ccui.Button:create("common/button_blue.png");
...
function PhoneLoginLayer:showRegister()
    ...
    local regLabel = ccui.Text:create("请依次填写下面注册信息", "Helvetica-Bold", 24);--"fonts/JDQTJ.TTF"
    regLabel:setColor(cc.c3b(249,250,131));
    regLabel:enableOutline(cc.c4b(141,0,166,255*0.7),2);
    regLabel:setPosition(cc.p(610, 480 ));
    self:addChild(regLabel);
    ...
    local getcode = ccui.Button:create("common/button_blue.png");
    ...
    local register = ccui.Button:create("common/button_green.png");
...
function PhoneLoginLayer:showForget()
    ...
    for i,v in ipairs(content) do
        ...
        titleLabe:setColor(cc.c3b(255,233,110));
        titleLabe:enableOutline(cc.c4b(141,0,166,255*0.7),2);
        titleLabe:setPosition(cc.p(10 + i * 23, 70 ));
        titleSprite:addChild(titleLabe);
    ...
    regLabel:setColor(cc.c3b(249,250,131));
    regLabel:enableOutline(cc.c4b(141,0,166,255*0.7),2);
    regLabel:setPosition(cc.p(550, 480 ));
    self:addChild(regLabel);
