...
function WenXinTiShiLayer:createUI(kind,tipStr)
    ...
    title:setContentSize(cc.size(200,52));
    title:setPosition(337, 398)
    ...
    if SystemNoticeType.SystemNoticeType_Bust_Bean_Receive_Alms == kind or SystemNoticeType.SystemNoticeType_Enter_Bean_Receive_Alms == kind then
        ...
        local dropbtn = ccui.Button:create("common/common_button3.png","common/common_button3.png")
        ...
        local callfunc = cc.CallFunc:create(function() 
        	...
        	if self.lefttime ==0 then
        		...
        		receivebtn:loadTextures("common/common_button3.png","common/common_button3.png")
        	end
        	end);
    ...
    elseif SystemNoticeType.SystemNoticeType_Bust_Bean == kind then
        --todo
        local cancelbtn = ccui.Button:create("common/common_button3.png","common/common_button3.png")
    ...
    elseif SystemNoticeType.SystemNoticeType_Wealth_Overflow == kind or SystemNoticeType.ClientNoticeType_goNextRoom == kind then
        ...
        if roomIndex == 2 then
            ...
            local isnext = true
            local gameServer = listData:getGameServer(roomIndex+1,1)
