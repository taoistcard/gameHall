...
function EffectFactory:getPaoMaDeng()
	...
	local filePath = "effect/eff_tanchuang_dengeffect/eff_tanchuang_deng.ExportJson"
	local imagePath = "effect/eff_tanchuang_dengeffect/eff_tanchuang_deng0.png"
	local plistPath = "effect/eff_tanchuang_dengeffect/eff_tanchuang_deng0.plist"
	local manager = ccs.ArmatureDataManager:getInstance()
	manager:addArmatureFileInfo(imagePath,plistPath,filePath)
	local armature = ccs.Armature:create(name)
	armature:getAnimation():playWithIndex(0)
