...
function NoticeLayer:createUI(kind)
    ...
    local pop_title = ccui.ImageView:create("hall/title_notice.png");
    ...
    self.listView:setContentSize(cc.size(450, 425))
    self.listView:setPosition(421,87)
...
function NoticeLayer:refreshList(kind)
    ...
    for i = 1, count do
        ...
        local titleLabel = ccui.Text:create(title,FONT_PTY_TEXT,22)
        ...
        titleLabel:setTextAreaSize(cc.size(253,76))
