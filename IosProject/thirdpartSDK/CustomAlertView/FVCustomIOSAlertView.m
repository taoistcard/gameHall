//
//  FVCustomIOSAlertView.m
//  FVCustomIOSAlertView
//
...
const static CGFloat kFVCustomIOSAlertViewDefaultButtonHeight       = 50;
const static CGFloat kFVCustomIOSAlertViewDefaultButtonSpacerHeight = 1;
const static CGFloat kFVCustomIOSAlertViewCornerRadius              = 7;
const static CGFloat kCustomIOS7MotionEffectExtent                = 10.0;

@implementation FVCustomIOSAlertView
...
- (void)customIOS7dialogButtonTouchUpInside: (FVCustomIOSAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
...
- (UIView *)createContainerView
{
    ...
    CGFloat cornerRadius = kFVCustomIOSAlertViewCornerRadius;
    gradient.cornerRadius = cornerRadius;
    [dialogContainer.layer insertSublayer:gradient atIndex:0];
    */
    
    dialogContainer.layer.cornerRadius = kFVCustomIOSAlertViewCornerRadius;
    dialogContainer.layer.borderColor = [[UIColor clearColor] CGColor];//[[UIColor colorWithRed:198.0/255.0 green:198.0/255.0 blue:198.0/255.0 alpha:1.0f] CGColor];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if (i > 0) {
            UIView *lineOfBtn = [[UIView alloc] initWithFrame:CGRectMake(i * buttonWidth, container.bounds.size.height - buttonHeight, 0.5, buttonHeight)];
            lineOfBtn.backgroundColor = [UIColor grayColor];
            [container addSubview:lineOfBtn];
        }
        ...
        [closeButton.layer setCornerRadius:kFVCustomIOSAlertViewCornerRadius];
...
- (CGSize)countScreenSize
{
    if (buttonTitles!=NULL && [buttonTitles count] > 0) {
        buttonHeight       = kFVCustomIOSAlertViewDefaultButtonHeight;
        buttonSpacerHeight = kFVCustomIOSAlertViewDefaultButtonSpacerHeight;
    } else {
        buttonHeight = 0;
